...
Anleitung zur Installation des Plugins (da das manchen Probleme bereitet hatte): https://randomnerdtutorials.com/install-esp8266-filesystem-uploader-arduino-ide/
